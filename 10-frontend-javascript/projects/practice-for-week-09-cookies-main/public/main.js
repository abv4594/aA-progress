...
function restoreName() {
    ...
    if (displayName) {
        setInputValue("display-name", displayName.split('=')[1]);
    }
}
...
// by me: returns the value of a cookie if it exists, if not ""

function getCookie(cookieName) {
    return document.cookie.split("; ").find(el => el.startsWith(cookieName))
    }
