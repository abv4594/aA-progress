...
function isSubString(searchString, subString) {
    ...
    // Your code here
    const searchNormalized = searchString.toLowerCase();
    const subNormalized = subString.toLowerCase();

    return searchNormalized.indexOf(subNormalized) !== -1;
};
